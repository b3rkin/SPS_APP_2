...
pmf_dir = os.path.join(parentDirectory,"APP2_DATA_PROCESSING - COPY","MACpmf")
...
if pmfcreate:
    ...
    for i in range(1,cell_number+1):
        dir = os.path.join(parentDirectory, "GatherData_Bayes", "All_dir", "saved_data_cell" + str(i) + "_totall.txt")
        create_pmf(dir,i)
